...
from opencood.models.fuse_modules.hmvit.base_transformer import HeteroPreNorm, HeteroFeedForward, \
    HeteroLayerNorm, HeteroPreNormResidual
from opencood.models.fuse_modules.hmvit.torch_transformation_utils import \
    get_roi_and_cav_mask, SpatialTransformation
...
class HeteroAttention(nn.Module):
    ...
    def forward(self, x, temp, mask=None, exclude_self=False):
        mode = torch.clone(temp)
        # mode[:] = 1
...
class HeteroFusionBlock(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.window_attention = HeteroAttention(input_dim,
                                                ...
                                                agent_size,
                                                window_size)
        # self.window_attention = PlainCAVttention(input_dim,
        #                                         dim_head,
        #                                         drop_out,
        #                                         agent_size,
        #                                         window_size)
        ...
        self.grid_attention = HeteroAttention(input_dim,
                                              ...
                                              agent_size,
                                              window_size)
        # self.grid_attention = PlainCAVttention(input_dim,
        #                                       dim_head,
        #                                       drop_out,
        #                                       agent_size,
        #                                       window_size)
